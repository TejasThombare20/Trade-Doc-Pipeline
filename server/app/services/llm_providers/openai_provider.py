"""OpenAI provider — wraps the vanilla OpenAI Python SDK.

This is essentially the original `services/llm.py` logic extracted into the
provider interface.
"""
